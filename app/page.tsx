...
const navItems = [
  { label: "Github", href: "https://git.new/Lumi", icon: GitHubLogoIcon },
  { label: "Docs", href: "https://docs.Lumi.sh", icon: BookOpenIcon },
];
...
export default function Home() {
  ...
  if (isMaintenanceMode) {
    login = () => {
      window.location.href = "https://x.com/Lumi_sh";
    };
  }
